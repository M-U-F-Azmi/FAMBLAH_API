...
//Database Connection
define('DB_NAME','famblahapi');   //your database username
...
define('JWT_SECRET_KEY', 'YOUR_SECRET_KEY');  							//your jwt secret key, Please use a very dificult secret key, which no one can guess it.
...
define('COMMENT_LIKE_FAILED', 701);
define('COMMENT_UNLIKED', 702);
define('COMMENT_UNLIKE_FAILED', 703);
